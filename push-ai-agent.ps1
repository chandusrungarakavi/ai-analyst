# ----------------------------------------
# PowerShell Script: push-ai-agent.ps1
# Builds and pushes ai-analyst-agent image to Google Artifact Registry using OAuth2
# ----------------------------------------

# Configurable values
$serviceName = "ai-analyst-agent"
$imageTag = "asia-south1-docker.pkg.dev/ai-analyst-for-startup-eval/ai-analyst/ai-analyst-ai-analyst-agent:latest"
