#!/bin/bash
# ----------------------------------------
# Shell Script: push-ai-agent.sh
# Builds and pushes ai-analyst-agent image to Google Artifact Registry using OAuth2
# ----------------------------------------

# Configurable values
SERVICE_NAME="ai-analyst-agent"
IMAGE_TAG="asia-south1-docker.pkg.dev/ai-analyst-for-startup-eval/ai-analyst/ai-analyst-ai-analyst-agent:latest"
